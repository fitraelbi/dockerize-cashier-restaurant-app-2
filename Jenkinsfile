                   ...
                   sshPublisher(
                        publishers: [
                            sshPublisherDesc(
                                ...
                                transfers: [
                                    sshTransfer(
                                        execCommand: 'docker rmi fitrakz/frontend:latest; docker rmi fitrakz/backend:latest; docker pull fitrakz/frontend:latest;  docker pull fitrakz/backend:latest; docker-compose down -v -f;  docker-compose up -d --renew-anon-volumes;',
                                        execTimeout: 120000,
                                    )
                                ]
                            )
