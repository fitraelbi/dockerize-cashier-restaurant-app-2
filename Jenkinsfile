                   ...
                   sshPublisher(
                        publishers: [
                            sshPublisherDesc(
                                ...
                                transfers: [
                                    sshTransfer(
                                        execCommand: 'docker rmi fitrakz/frontend:latest; docker rmi fitrakz/backend:latest; docker pull fitrakz/frontend:latest;  docker pull fitrakz/backend:latest;  docker-compose rm -f;  docker-compose up --build -d;',
                                        execTimeout: 120000,
                                    )
                                ]
                            )
